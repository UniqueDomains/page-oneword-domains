# Available .PAGE One-Word Domains (21,079)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-21%2C079%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **21,079 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 21,079 domains · **Median ask:** $58.65 · **High-demand under $2,500:** 12
...
| ----------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------- |
| out.page    | premium   | $623.75   | —             | high           | low    | 3      | name.com          |
| bad.page    | premium   | $623.75   | —             | high           | medium | 3      | name.com          |
| off.page    | premium   | $623.75   | —             | high           | low    | 3      | name.com          |
| period.page | premium   | $161.25   | —             | high           | low    | 6      | name.com          |
| bang.page   | premium   | $311.25   | —             | high           | low    | 4      | name.com          |
| soft.page   | premium   | $623.75   | $623.75       | high           | low    | 4      | name.com          |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 21,079 live domains                        |
...
> Unique Domains. *Available .PAGE One-Word Domains*. Version 2026-09-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
